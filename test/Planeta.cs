...
namespace DeepSpace
{
    class Planeta : GameObject, IDisposable
    {
        ...
        public Planeta(Game game, Vector2 position, uint size, int team, uint population): base(game)
        {
            this.position = position;
            this.size = size;
            this.population = population;
        ...
        public bool EsPlanetaDeLaIA() //Si el planeta pertenece al Bot retorna true y false en caso contrario.
        {
        	return team==2;
        }
        
        public bool EsPlanetaDelJugador() //Si el planeta pertenece al usuario del juego retorna true y false en caso contrario.
        {
        	return team==1;
        }
        
        public bool EsPlanetaNeutral() //Si el planeta no pertenece ni al usuario del juego, ni al Bot retorna true y false en caso contrario.
        {
        	return team==0;
        }
        
        public int Poblacion() //Retorna la población actual del planeta.
        {
